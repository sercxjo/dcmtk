if(WIN32 AND NOT MINGW)
  ...
  if(LIBICONV_DIR STREQUAL "")
    file(GLOB LIBICONV_DIR "${DCMTK_SOURCE_DIR}/../..")
  endif()
  ...
  if(DCMTK_WITH_XML)
    if(WITH_LIBXMLINC)
      ...
      set(LIBXML_LIBS debug "${LIBXML_LIBDIR}/libxml2${CMAKE_DEBUG_POSTFIX}.lib" optimized "${LIBXML_LIBDIR}/libxml2${CMAKE_RELEASE_POSTFIX}.lib"
                      debug "${LIBXML_LIBDIR}/iconv${CMAKE_DEBUG_POSTFIX}.lib" optimized "${LIBXML_LIBDIR}/iconv${CMAKE_RELEASE_POSTFIX}.lib")
  ...
  if(DCMTK_WITH_PNG)
    if(WITH_LIBPNGINC)
      ...
      set(LIBPNG_LIBS debug "${LIBPNG_LIBDIR}/libpng${CMAKE_DEBUG_POSTFIX}.lib" optimized "${LIBPNG_LIBDIR}/libpng${CMAKE_RELEASE_POSTFIX}.lib")
  ...
  if(DCMTK_WITH_TIFF)
    if(WITH_LIBTIFFINC)
      ...
      set(LIBTIFF_LIBS debug "${LIBTIFF_LIBDIR}/libtiff${CMAKE_DEBUG_POSTFIX}.lib" optimized "${LIBTIFF_LIBDIR}/libtiff${CMAKE_RELEASE_POSTFIX}.lib")
  ...
  if(DCMTK_WITH_OPENSSL)
    if(WITH_OPENSSLINC)
      ...
      set(OPENSSL_LIBS "crypt32" debug "${OPENSSL_LIBDIR}/dcmtkssl${CMAKE_DEBUG_POSTFIX}.lib" optimized "${OPENSSL_LIBDIR}/dcmtkssl${CMAKE_RELEASE_POSTFIX}.lib" debug "${OPENSSL_LIBDIR}/dcmtkcrypto${CMAKE_DEBUG_POSTFIX}.lib" optimized "${OPENSSL_LIBDIR}/dcmtkcrypto${CMAKE_RELEASE_POSTFIX}.lib")
  ...
  if(DCMTK_WITH_ZLIB)
    if(WITH_ZLIBINC)
      ...
      set(ZLIB_LIBS debug "${ZLIB_LIBDIR}/zlib${CMAKE_DEBUG_POSTFIX}.lib" optimized "${ZLIB_LIBDIR}/zlib${CMAKE_RELEASE_POSTFIX}.lib")
  ...
  if(DCMTK_WITH_SNDFILE)
    if(WITH_SNDFILEINC)
      ...
      set(SNDFILE_LIBS debug "${SNDFILE_LIBDIR}/libsndfile${CMAKE_DEBUG_POSTFIX}.lib" optimized "${SNDFILE_LIBDIR}/libsndfile${CMAKE_RELEASE_POSTFIX}.lib")
  ...
  if(DCMTK_WITH_ICONV)
    if(WITH_LIBICONVINC)
      ...
      set(LIBICONV_LIBS debug "${LIBICONV_LIBDIR}/libiconv${CMAKE_DEBUG_POSTFIX}.lib" optimized "${LIBICONV_LIBDIR}/libiconv${CMAKE_RELEASE_POSTFIX}.lib"
                      debug "${LIBICONV_LIBDIR}/libcharset${CMAKE_DEBUG_POSTFIX}.lib" optimized "${LIBICONV_LIBDIR}/libcharset${CMAKE_RELEASE_POSTFIX}.lib")
